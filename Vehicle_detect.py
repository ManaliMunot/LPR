...
def  get_plate(image):
    ...
    ROI: List[Any] = []
    net = cv2.dnn.readNet('/home/aditya/sih/sih_cb31/res/lapi.weights',
                          '/home/aditya/sih/sih_cb31/res/lapi.cfg')
    coco_name = '/home/aditya/sih/sih_cb31/res/lapi_class.names'
...
def  get_vehicle(image):
    ...
    height, width, channels = img.shape
    ROI: List[Any] = []
    net = cv2.dnn.readNet('/home/aditya/sih/sih_cb31/res/yolov3.weights',
                          '/home/aditya/sih/sih_cb31/res/yolov3.cfg')
    stat = False
    layer_names = net.getLayerNames()
    output_layers = [layer_names[i[0] - 1] for i in net.getUnconnectedOutLayers()]
